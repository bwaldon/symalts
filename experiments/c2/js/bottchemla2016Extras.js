...
var symPre = ["Some of the symbols are", "There are four", "There is a", "Some but not all of the symbols are", "There are four but no more than four", ["There is a", "but nothing else"]]
  ...
  if (condition_2 == 2) { // prime_type == exhaustive
    if (triplet !== 2) {
      ...
      if (condition == 2) // adhoc
        condText = "" + symPre[condition+3][0] + " " + symText[symbols[0]] + " " + symPre[condition+3][1] + "." // Brandon mod 
    }
  }
