...
var symPre = ["Some of the symbols are", "There are four", "There is a", "Only some of the symbols are", "There are only four", "There is only a"]
  ...
  if (condition_2 == 2) { // prime_type == exhaustive
    if (triplet !== 2) {
      ...
      if (condition == 2) // adhoc
        condText = "" + symPre[condition+3] + " " + symText[symbols[0]] + "."
    }
  }
